...
SIGNATURES: tuple[Layer, ...] = (
    _layer("http", "synchronous HTTP tier", "fastapi", "flask", "django", "express", "starlette",
           "next", "hono", "koa", "aiohttp"),
    _layer("worker", "asynchronous worker tier", "celery", "rq", "dramatiq", "bullmq", "arq",
           "temporalio", infra=True),
    _layer("broker", "message broker", "kombu", "pika", "kafka-python", "confluent-kafka",
           "amqplib", "nats-py", infra=True),
    _layer("cache", "cache or ephemeral store", "redis", "aiocache", "ioredis", "memcached",
           infra=True),
    _layer("relational", "relational database", "sqlalchemy", "psycopg", "psycopg2", "asyncpg",
           "prisma", "drizzle-orm", "pg", "mysqlclient", infra=True),
    _layer("embedded_db", "embedded datastore", "sqlite3", "aiosqlite", "duckdb", "better-sqlite3"),
    _layer("vector", "vector index", "qdrant-client", "chromadb", "pinecone-client", "weaviate-client",
           "lancedb", "faiss-cpu", "faiss-gpu", "pgvector", "milvus", infra=True),
    _layer("llm_api", "hosted model provider", "openai", "anthropic", "litellm", "cohere",
           "google-generativeai", "mistralai"),
    _layer("llm_local", "local inference", "vllm", "llama-cpp-python", "ollama", "transformers",
           "ctranslate2", infra=True),
    _layer("orchestration", "agent orchestration framework", "langchain", "langgraph", "llama-index",
           "crewai", "autogen", "haystack-ai", "dspy-ai"),
    _layer("telemetry", "telemetry export", "opentelemetry-api", "opentelemetry-sdk",
           "prometheus-client", "sentry-sdk", "datadog", "langsmith"),
    _layer("queueing_cloud", "managed cloud services", "boto3", "google-cloud-storage",
           "azure-storage-blob", infra=True),
    _layer("ui", "shipped user interface", "react", "vue", "svelte", "streamlit", "gradio", "textual"),
